  ...
  return (
    <header className=" max-w-6xl mx-auto flex flex-wrap items-center justify-between p-4 h-20 text-white">
      <div className="flex items-center gap-10 z-50">
        <Link
          to="/"
          className="flex items-center gap-1 text-red-600 font-extrabold text-2xl"
        >
          <Tv2 size={32} />
          NETFLIXGPT
        </Link>
      ...
      <div className="flex gap-2 items-center z-50">
        <Link to={"/search"}>
          <button
            className="flex items-center gap-2 px-4 py-2 rounded-full text-white text-sm font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-violet-500/40"
